...
public class GameSettings {
    ...
    public static final int TIME_BEFORE_WAVE_START = 1; //default 10
    public static final int BREAK_TIME_BETWEEN_WAVES = 3; //default 8
    ...
    public static final double ENEMY_SPEED = 0.1; // default 1
